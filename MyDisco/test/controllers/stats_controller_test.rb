...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post stats_url, params: { stat: { elem: @stat.elem, name: @stat.name, total: @stat.total } }
    end
  ...
  test "should update stat" do
    patch stat_url(@stat), params: { stat: { elem: @stat.elem, name: @stat.name, total: @stat.total } }
